...
public class SwipeView extends javax.swing.JFrame {
  ...
  public void checkAll(Letter letter) {
    for (Component c : formsPanel.getComponents()) {
      Form form = (Form) c;
      form.check(letter);
    }
  }
  ...
  /**
   * Método que adiciona uma label no painel transition, responsável pela
   * animação de transição dos exemplos das letras
   *
   * @param component JLabel
   */
  public static void addTransitionLabels(JLabel component, int index) {
    lowerCaseAnimation.add(component, index);
  }//fim addLabels
  ...
  private void initComponents() {
    ...
    lowerCaseAnimation = new view.components.LowerCaseLetterAnimation();
    ...
    itensTable.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 65, 100, 125));
    ...
    javax.swing.GroupLayout itensTableLayout = new javax.swing.GroupLayout(itensTable);
    itensTable.setLayout(itensTableLayout);
    itensTableLayout.setHorizontalGroup(
      itensTableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, itensTableLayout.createSequentialGroup()
        .addGap(0, 24, Short.MAX_VALUE)
        .addComponent(formsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE))
    );
    itensTableLayout.setVerticalGroup(
      itensTableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, itensTableLayout.createSequentialGroup()
        .addContainerGap(50, Short.MAX_VALUE)
        .addComponent(formsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addContainerGap())
    );
  ...
  private static view.components.LowerCaseLetterAnimation lowerCaseAnimation;
